package com.ghsong.studymeeting.modules.event.validator;

import com.ghsong.studymeeting.modules.event.Event;
...
public class EventValidator implements Validator {
    ...
    protected boolean isNotValidEndEnrollmentDateTime(EventForm eventForm) {
        return eventForm.getEndEnrollmentDateTime().isBefore(LocalDateTime.now());
    }

    protected boolean isNotValidEndDateTime(EventForm eventForm) {
